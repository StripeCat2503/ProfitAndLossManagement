...
class NewIncomeReceiptScreen extends StatefulWidget {
  @override
  _NewIncomeReceiptScreenState createState() => _NewIncomeReceiptScreenState();
}

class _NewIncomeReceiptScreenState extends State<NewIncomeReceiptScreen> {
...
// picking an image from camera of device
  ...
  addNewIncome() {
    ...
    bloc.createIncomeReceipt(_receipt, _receiptImages);
  }
